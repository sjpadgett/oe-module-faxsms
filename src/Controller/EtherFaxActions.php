    ...
    public function getPending()
    {
        ...
        try {
            ...
            foreach ($faxStore as $fax) {
                ...
                $downloadLink = "<a role='button' href='javaScript:' onclick=\"getDocument(event, '','$id_esc', 'true')\"> <span class='fa fa-download'></span></a>";
                $viewLink = "<a role='button' href='javaScript:' onclick=\"getDocument(event, null, '$id_esc', 'false')\"> <span class='fa fa-file-pdf'></span></a>";
                $details_esc = json_encode($details);
                $forwardLink = "<a role='button' href='javaScript:' onclick='forwardFax(event, \"$id_esc\")'> <span class='fa fa-forward'></span>";
                $detailLink = '';
                if ($showFlag) {
